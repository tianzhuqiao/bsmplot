...
## Plot the data
To plot the data, simply double click on a signal. It will either plot on the current figure window, or create one (if there is no figure window) then plot.

<img src="./docs/plot.png?raw=true" width="600"></img>

You can also drag the signal to the figure window you want to show the data.
...
Many operations of the figure can be done in the right-click menu, and the toolbar on top. For example, to create a subplot with shared x-axis,

<img src="./docs/plot2.png?raw=true" width="600"></img>

## Process the data

To process the data, right click on the signal, and select the function to run. Currently 4 founctions are predefined
...
If you are familer with python code, you can add your own founctions. You basically need to define the **input**, **equation**, and **output**. The number of **output** shall match the actual ones returned from the **equation**.
