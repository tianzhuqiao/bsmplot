...
class DirPanel(wx.Panel):
    ...
    def new_folder(self):
        ...
        dlg = wx.TextEntryDialog(self, "Folder name", caption=parent.GetLabel(), value='')
        dlg.ShowModal()
        ...
        if  os.path.exists(new_folder):
            ...
            dlg = wx.GenericMessageDialog(self, msg, parent.GetLabel(), style=wx.OK)
            dlg.ShowModal()
            dlg.Destroy()
            return
